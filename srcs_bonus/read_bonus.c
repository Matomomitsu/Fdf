...
/*   Updated: 2022/08/23 03:21:21 by mtomomit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_point	*ft_pointnew(double x, double y, double z)
{
	...
	new->converted.x = 0.0;
	new->converted.y = 0.0;
	new->converted.rotated.z = z;
	new->converted.rotated.x = x;
	new->converted.rotated.y = y;
	new->converted.rotated.rot_z = 0.0;
	new->converted.rotated.rot_x = 0.0;
	new->converted.rotated.rot_y = 0.0;
	new->converted.translated.trans_x = 0.0;
	new->converted.translated.trans_y = 0.0;
	return (new);
}
